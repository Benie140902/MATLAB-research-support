...
Or else you can generate test vectors from srsRAN and check your algorithm is compatible to 5G standards if you lack in hardware using ch_sim_estimation code.
